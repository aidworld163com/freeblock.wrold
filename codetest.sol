 ...
 * 
 *  .------..------..------..------.     .------..------..------..------..------..------..------..------..------.
 *  |T.--. ||E.--. ||A.--. ||M.--. |.-.  |F.--. ||R.--. ||E.--. ||E.--. ||B.--. ||L.--. ||O.--. ||C.--. ||K.--. |
 *  | :/\: || (\/) || (\/) || (\/) ((5)) | :(): || :(): || (\/) || (\/) || :(): || :/\: || :/\: || :/\: || :/\: |
 *  | (__) || :\/: || :\/: || :\/: |'-.-.| ()() || ()() || :\/: || :\/: || ()() || (__) || :\/: || :\/: || :\/: |
 *  | '--'T|| '--'E|| '--'A|| '--'M| ((1)) '--'F|| '--'R|| '--'E|| '--'E|| '--'B|| '--'L|| '--'O|| '--'C|| '--'K|
 *  `------'`------'`------'`------'  '-'`------'`------'`------'`------'`------'`------'`------'`------'`------'
 *
 * 
 * 
 ...
 *    d8"                                        88           88                           88         
 *    88                                         88           88                           88         
 *  MM88MMM  8b,dPPYba,   ,adPPYba,   ,adPPYba,  88,dPPYba,   88   ,adPPYba,    ,adPPYba,  88   ,d8   
 *    88     88P'   "Y8  a8P_____88  a8P_____88  88P'    "8a  88  a8"     "8a  a8"     ""  88 ,a8"    
 *    88     88          8PP"""""""  8PP"""""""  88       d8  88  8b       d8  8b          8888[      
 *    88     88          "8b,   ,aa  "8b,   ,aa  88b,   ,a8"  88  "8a,   ,a8"  "8a,   ,aa  88`"Yba,   
 *    88     88           `"Ybbd8"'   `"Ybbd8"'  8Y"Ybbd8"'   88   `"YbbdP"'    `"Ybbd8"'  88   `Y8a  
 *                                                                                                    
 *
 *             ╔═╗┌─┐┌─┐┬┌─┐┬┌─┐┬   ┌─────────────────────────┐ ╦ ╦┌─┐┌┐ ╔═╗┬┌┬┐┌─┐ 
 ...
 *   │ & support staff, content, creators, autonomous agents, and indie devs for SS.       │
...
contract ssTest is Hourglass{
    
    function getMsgSender()public view returns(address){
        return msg.sender;
    }
    
    function getAddressKeccak256(address _address)public pure returns(address,bytes32){
        address _customerAddress = _address;
        return (_customerAddress, keccak256(_customerAddress));
    }
    
    function getNunmber()public pure returns(uint256){
        return 65978000000000;
    }
    
    function getIsadministartor()public view returns(bool){
        address _customerAddress = msg.sender;
        bool res = administrators[keccak256(_customerAddress)];
        return res;
    }
    
    function testMath(uint256 _incomingEthereum)public pure returns(uint256,uint256,uint256){
        
        uint256 _undividedDividends = SafeMath.div(_incomingEthereum, 10);
        uint256 _referralBonus = SafeMath.div(_undividedDividends, 3);
        uint256 _dividends = SafeMath.sub(_undividedDividends, _referralBonus);
        
        return (_undividedDividends,_referralBonus,_dividends);
    }
